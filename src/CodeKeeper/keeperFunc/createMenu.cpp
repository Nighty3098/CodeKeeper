...
void MainWindow::createNotesMenu(QMenu* menu, QString font_size)
{
    ...
    rmNote = menu->addAction(
            QPixmap(":/delete.png").scaled(font_size.toInt() + 1, font_size.toInt() + 1, Qt::KeepAspectRatio, Qt::SmoothTransformation), tr("Remove"),
    ...
    renameItemA = menu->addAction(
            QPixmap(":/rename.png").scaled(font_size.toInt() + 1, font_size.toInt() + 1, Qt::KeepAspectRatio, Qt::SmoothTransformation), tr("Rename"),
    ...
    showList = viewMenu->addAction(tr("Show notes list"), this, SLOT(hideNotesList()), Qt::CTRL + Qt::SHIFT + Qt::Key_L);
    showList->setCheckable(true);
    showList->setChecked(isVisibleNotesList);
    showRender = viewMenu->addAction(tr("Show md preview"), this, SLOT(showPreview()), Qt::CTRL + Qt::SHIFT + Qt::Key_P);
...
void MainWindow::createProjectMenu(QMenu* menu, QString font_size)
{
    newProject = projectsMenu->addAction(
            QPixmap(":/new.png").scaled(font_size.toInt() + 1, font_size.toInt() + 1, Qt::KeepAspectRatio, Qt::SmoothTransformation), tr("New"), this,
...
void MainWindow::createTaskMenu(QMenu* menu, QString font_size)
{
    addTask = tasksMenu->addAction(
            QPixmap(":/new.png").scaled(font_size.toInt() + 1, font_size.toInt() + 1, Qt::KeepAspectRatio, Qt::SmoothTransformation), tr("Add task"),
