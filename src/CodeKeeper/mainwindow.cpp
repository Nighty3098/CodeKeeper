...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
  ...
  incompleteTasks->setStyleSheet(
      "background-color: rgb(255, 117, 127, 180); color: #FFFFFF; "
  ...
  inprocessTasks->setStyleSheet("background-color: rgb(255, 199, 119, 180); "
  ...
  completeTasks->setStyleSheet("background-color: rgb(195, 232, 141, 180); "
  ...
  notStartedProjects->setStyleSheet("background-color: rgb(255, 117, 127, "
  ...
  finishlineProjects->setStyleSheet("background-color: rgb(130, 170, 255, "
                                    "180); color: #000000; border-width: 0px; "
                                    "border-color: #82aaff; "
                                    "font-size: " +
                                    font_size + "pt;");
