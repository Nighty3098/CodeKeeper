...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SyncWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SyncWindow_t qt_meta_stringdata_SyncWindow = {
    {
QT_MOC_LITERAL(0, 0, 10), // "SyncWindow"
QT_MOC_LITERAL(1, 11, 15), // "checkConnection"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16), // "startSyncingFunc"
QT_MOC_LITERAL(4, 45, 17) // "cancelSyncingFunc"

    },
    "SyncWindow\0checkConnection\0\0"
    "startSyncingFunc\0cancelSyncingFunc"
};
...
void SyncWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { bool _r = _t->checkConnection();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->startSyncingFunc(); break;
        case 2: _t->cancelSyncingFunc(); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject SyncWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_SyncWindow.data,
